const historyHard = {
  ...
  questions: [
    ...
    },
    {
      ...
      answers: [
        { text: 'King Willam IV', isCorrect: false },
    ...
    },
    {
      ...
      answers: [
        { text: 'Mehmed II', isCorrect: false },
